    ...
    public class KestrelConfigurationLoader
    {
        ...
        private void LoadDefaultCert(ConfigurationReader configReader)
        {
            ...
            else
            {
                ...
                var certificate = FindDeveloperCertificate(configReader, logger);
                if (certificate != null)
                {
        ...
        private X509Certificate2 FindDeveloperCertificate(ConfigurationReader configReader, ILogger<KestrelServer> logger)
        {
            ...
            try
            {
                ...
                {
                    return new X509Certificate2(certificatePath, certificateConfig.Password);
                }
